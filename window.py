...
from PyQt5.QtWidgets import QWidget, QVBoxLayout, QScrollArea, QMainWindow, QInputDialog, QSizePolicy
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, widgets=None):
        ...
        self.setBaseSize(500, 700)

        self.max_width, self.max_height = 450, 250

        self.music_player = AudioPlayer()
        # self.music_player.setFixedSize(self.max_width, self.max_height)
        # self.music_player.setSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
    ...
    def replace_widgets_to_player(self, playlist=None):
        self.remove_widgets()
        self.main_layout = QVBoxLayout(self.central_widget)
        self.back_to_menu_button = SongButton("Go Back")
    ...
    def make_widgets(self):
        ...
        self.file_dialog2 = SongButton("See all songs in Music folder")
    ...
    def display_playlist_songs(self, playlists_path: str, all_songs: list = None):
        ...
        self.back_to_playlist_button = SongButton("Go Back")
        ...
        if not all_songs:
            self.remove_playlist_button = SongButton("Remove this playlist")
    ...
    def display_all_songs(self, all_songs: list):
        ...
        self.back_button = SongButton("Go Back")
        ...
        for song in all_songs:
            song_button = SongButton(song.split("/")[-1])
            song_button.clicked.connect(lambda song=song: start_music_player(self,
                                                                             song,
                                                                             self.music_player,
                                                                             all_songs))
            song_layout.addWidget(song_button)
    ...
    def show_playlists(self):
        ...
        self.add_playlist_button = SongButton("Add existing playlist")
        ...
        self.create_playlist_button = SongButton("Create new playlist")
        ...
        if playlists_names:
            for playlists_name in playlists_names:
                playlist_button = SongButton(playlists_name.split("/")[-1])
